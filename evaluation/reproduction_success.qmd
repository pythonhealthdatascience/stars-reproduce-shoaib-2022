...
Table 6 was run with 100 replications, although this took a long time and results were very similar to with 10 replications. Since all remaining results present mean results, it was felt that running 10 replications should have a fairly minimal impact on the results, and save alot of time, and so all model variants in the sensitivity analysis were run with 10 replications.
