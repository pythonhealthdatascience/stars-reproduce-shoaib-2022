...
Reproduced in-text result 5 but couldn't get 7 so emailed author. Total time used: 28h 14m (70.6%). Started on evaluation against guidelines.
...
Archived repository on Zenodo, marking the end of reproduction (unless any further suggestions later from email).