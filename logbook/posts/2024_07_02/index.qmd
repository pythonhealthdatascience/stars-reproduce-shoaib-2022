...
* Tests
    ...
    * The tests were very slow to run as they ran sequentially (and for each test, it would run 10 replications of the model with particular parameters, which took a while). Add `pytext-xdist` to environment to all parallelisation of tests
